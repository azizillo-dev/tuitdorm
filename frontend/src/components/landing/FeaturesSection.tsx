...
export function FeaturesSection() {
  return (
    <section id="features" className="py-16 sm:py-24 bg-surface border-b border-divider">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* 4 Custom Feature Sections with SVG Technical Diagrams */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
          
          {/* Feature 1: Real-time Attendance Tracking */}
          <div className="border border-divider rounded-[2px] bg-page p-6 sm:p-8 flex flex-col justify-between">
            <div>
            ...
            <div className="bg-surface border border-divider rounded-[2px] p-4 font-mono text-xs shadow-2xs">
              ...
              <div className="py-3 space-y-2.5">
                <div className="flex items-center justify-between border-b border-divider pb-2">
                  ...
                  <span className="inline-flex items-center space-x-1.5 px-2 py-0.5 rounded-[2px] bg-[#3A7D5C]/10 text-[#3A7D5C] text-[11px] font-bold">
                ...
                <div className="flex items-center justify-between border-b border-divider pb-2">
                  ...
                  <span className="inline-flex items-center space-x-1.5 px-2 py-0.5 rounded-[2px] bg-[#C08A2E]/10 text-[#C08A2E] text-[11px] font-bold">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="inline-flex items-center space-x-1.5 px-2 py-0.5 rounded-[2px] bg-[#B23B3B]/10 text-[#B23B3B] text-[11px] font-bold animate-pulse">
              ...
              <div className="text-[10px] text-muted pt-2 border-t border-divider flex justify-between items-center">
                ...
                <span className="bg-ink text-surface px-1.5 py-0.5 rounded-[2px] font-bold">QAYD ETILDI</span>
              </div>
            </div>
          </div>
            ...
            <div className="bg-surface border border-divider rounded-[2px] p-4 font-mono text-xs shadow-2xs">
              ...
              <div className="py-3">
                ...
                <div className="grid grid-cols-7 gap-1 text-center text-[11px]">
                  ...
                  {[6, 7, 8, 9, 10, 11].map((d) => (
                    <div key={d} className="p-1 bg-page border border-divider rounded-[2px] text-sub">{d}</div>
                  ))}
                  <div className="p-1 bg-[#B23B3B]/15 border border-[#B23B3B] rounded-[2px] text-[#B23B3B] font-bold">12</div>
                  <div className="p-1 bg-[#B23B3B]/15 border border-[#B23B3B] rounded-[2px] text-[#B23B3B] font-bold">13</div>
                  <div className="p-1 bg-[#B23B3B]/20 border border-[#B23B3B] rounded-[2px] text-[#B23B3B] font-bold ring-2 ring-[#B23B3B]/40">14</div>
                  {[15, 16, 17, 18, 19].map((d) => (
                    <div key={d} className="p-1 bg-page border border-divider rounded-[2px] text-sub">{d}</div>
                  ))}
                </div>
              </div>
              <div className="bg-[#B23B3B]/10 border border-[#B23B3B]/30 rounded-[2px] p-2.5 text-[11px] text-[#B23B3B] flex items-start space-x-2">
          ...
          <div className="border border-divider rounded-[2px] bg-page p-6 sm:p-8 flex flex-col justify-between">
            ...
            <div className="bg-surface border border-divider rounded-[2px] p-4 font-mono text-xs shadow-2xs">
              <div className="text-[10px] text-muted uppercase pb-2 border-b border-divider flex justify-between items-center">
                ...
                <span className="bg-[#2E4A78] text-surface px-1.5 py-0.5 rounded-[2px] text-[9px] font-bold uppercase tracking-wider">
                  YUKLASH TAYYOR
                </span>
              </div>
              <div className="py-3">
                <div className="grid grid-cols-12 gap-1 border border-divider bg-page text-[10px] font-bold text-sub text-center py-1">
                ...
                <div className="divide-y divide-divider border-x border-b border-divider text-[11px]">
          ...
          <div className="border border-divider rounded-[2px] bg-page p-6 sm:p-8 flex flex-col justify-between">
            ...
            <div className="bg-surface border border-divider rounded-[2px] p-4 font-mono text-xs shadow-2xs">
              ...
              <div className="py-3 space-y-2 text-[11px]">
                <div className="p-2 bg-ink text-surface rounded-[2px] flex items-center justify-between font-bold">
                  <span>SUPER_ADMIN (Universitet IT)</span>
                  <span className="text-[10px] bg-surface/20 px-1.5 py-0.5 rounded-[2px]">BARCHA BINOLAR [A, B, C, D]</span>
                </div>
                <div className="pl-4 border-l-2 border-accent space-y-2">
                  <div className="p-2 bg-page border border-divider rounded-[2px] flex items-center justify-between font-medium text-main">
                  ...
                  <div className="pl-4 border-l-2 border-divider space-y-2">
                    <div className="p-2 bg-surface border border-divider rounded-[2px] flex items-center justify-between font-medium text-main">
                    ...
                    <div className="pl-4 border-l-2 border-divider">
                      <div className="p-1.5 bg-page border border-divider rounded-[2px] text-[10px] text-sub flex items-center justify-between">
