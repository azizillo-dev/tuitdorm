    ...
    <header className="sticky top-0 z-50 bg-surface border-b border-divider transition-colors duration-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        ...
        <Link href="/" className="flex items-center space-x-3 group">
          <div className="w-9 h-9 bg-ink text-surface flex items-center justify-center rounded-[2px] font-mono font-bold text-lg tracking-tight border border-sidebarborder">
            TATU
          </div>
        ...
        <div className="flex items-center space-x-6 sm:space-x-8">
          ...
          <div className="flex items-center space-x-3">
            ...
            <Link
              href="/dashboard"
              className="inline-flex items-center space-x-2 bg-ink text-surface px-4 py-2 text-sm font-medium rounded-[2px] border border-sidebarborder hover:bg-accent hover:border-accent transition-colors duration-150 shadow-sm"
            >
